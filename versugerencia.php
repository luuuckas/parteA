...
<html>
    ...
    <head>
        ...
        <link href="../CSS/estilo_versugerencias.css" rel="stylesheet" type="text/css"/>
    ...
    <body id="colorcontenedorpreguntas">
        ...
        <div class="sugerencia_general">
            ...
            <p class="nombre_suge_bd">Nombres de los Usuarios que llenaron el formulario</p>

            <div class="sugerencianombreBD">
                <?php foreach ($listasugerencia as $filasugerencia) { ?>

                    <div class="contenedor_de_nombres_sugerencia_bd">
                        <div class="contenedornombresugerencia"><?php echo $filasugerencia["nombre_usuario_sugerencia"] ?></div>
                    </div> 
            ...
            <p class="sugerencia_suge_bd">Sugerencias de los Usuarios que llenaron el formulario</p>

            <div class="sugerenciasugerenciaBD">
                <?php foreach ($listasugerencia as $filasugerencia) { ?>               

                    <div class="contenedor_de_sugerencia_sugerencia_bd">
                        <div class="contenedorsugerenciasugerencia"><?php echo $filasugerencia["sugerencia"] ?></div>
                    </div> 
