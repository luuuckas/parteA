...
<html>
    ...
    <body class="colorpreguntafrecuente">
        ...
        <div id="contenedorpreguntas">
            ...
            <section class="faq-item10">
               <div class="faq-box10">
               <h2>¿Cuál es el tiempo de respuesta para las reparaciones de radiadores?</h2>
               <p>Respuesta: Nuestro objetivo es brindar un servicio rápido y eficiente a nuestros clientes. El tiempo de respuesta para las reparaciones de radiadores puede variar según la magnitud del trabajo, pero nos esforzamos por completar las reparaciones de manera oportuna. Puedes comunicarte con nosotros para obtener estimaciones de tiempo específicas en función de tus necesidades.</p>
            </div>
            </section>
